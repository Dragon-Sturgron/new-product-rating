...
<head>
  ...
  <title>新品评审后台</title>
  <link rel="stylesheet" href="/assets/style.css?v=20260720-review-link-required-v11" />
</head>
<body>
      ...
      <section id="scoreSection" class="card list-card hidden">
        <div class="section-title search-title">
          ...
          <form id="scoreSearchForm" class="search-form score-search-form">
            ...
            <select name="review_link_code" id="scoreReviewLinkFilter" title="按评分链接筛选">

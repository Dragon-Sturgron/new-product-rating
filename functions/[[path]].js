...
<head>
  ...
  <title>新品评审后台</title>
  <link rel="stylesheet" href="/assets/style.css?v=20260720-review-link-required-v5" />
</head>
<body>
  ...
  <main class="container public-container">
    <section class="login-card card access-error-card" role="alert">
      <div class="brand">
        ...
        <div>
          <h1>无法进入评分</h1>
          <p>请勿直接访问系统域名，评分必须通过管理员生成的有效链接进入。</p>
        </div>
      </div>
      <p class="access-error-tip">请勿直接访问系统域名，评分必须通过管理员生成的有效链接进入。</p>
    </section>
